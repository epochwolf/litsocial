...
ActiveRecord::Schema.define(:version => 20130518171744) do
  ...
  add_index "bookmarks", ["user_id", "story_id"], :name => "index_bookmarks_on_user_id_and_story_id", :unique => true
  ...
  create_table "stories", :force => true do |t|
    ...
    t.string   "tags",            :default => [],                 :array => true
    t.integer  "paragraph_count", :default => 0
  end
