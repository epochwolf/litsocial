...
class StoriesControllerTest < ActionController::TestCase
  ...
  test "create should get redirected to story if logged in" do
    sign_in users(:one)
    assert_difference('Story.count') do
      post :create, :story => {:title => "Hi", :contents => "<b>yippie!</b>"}
    end
  ...
  test "create should render edit if logged in and invalid data" do
    ...
    assert_no_difference('Story.count') do
      post :create, :story => {:title => "", :contents => "<b>yippie!</b>"}
    end
    assert_response 200
  end
  ...
  test "should get update if logged in as owner" do
    sign_in users(:one)
    post :update, :id => 1,:story => {:title => "Hi", :contents => "<b>yippie!</b>"}
    assert_redirected_to story_path(assigns(:story))
  end
  ...
  test "should get not update if logged in as owner and sends invalid data" do
    sign_in users(:one)
    post :update, :id => 1,:story => {:title => "", :contents => "<b>yippie!</b>"}
    assert_response 200
  end
